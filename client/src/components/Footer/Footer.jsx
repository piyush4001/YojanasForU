  ...
  return (
    <footer className="bg-gray-900 text-gray-300 pt-10 pb-6 mt-16">
      <div className="max-w-7xl mx-auto px-4">
        {/* Grid: Stack on mobile, 2 cols on sm, 4 cols on md+ */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-sm">Phone: +91-9826878292, +91-7489931006</p>
            <p className="text-sm">Location: Indore, India</p>
          </div>
        </div>

        {/* Bottom Footer */}
        <div className="border-t border-gray-700 mt-10 pt-6 text-center text-xs sm:text-sm text-gray-400">
          © {new Date().getFullYear()} Scheme Portal. All rights reserved.
        </div>
      </div>
    </footer>

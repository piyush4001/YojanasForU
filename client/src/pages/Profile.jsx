...
// import { UserCircle2 } from "lucide-react"; // Avatar icon
...
//             <span className="text-right">{user.phoneNo}</span>
//           </div>
//         </div>
...
//         label="Phone Number"
//         value={user.phoneNo || "Not provided"} // Graceful fallback
//       />
//     </div>

//     {/* Action Button */}
//     <div className="px-6 pb-6">
//       <button className="w-full flex items-center justify-center px-4 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
...
//         <div className="space-y-2">
//           <div className="h-4 w-24 bg-gray-200 dark:bg-gray-700 rounded-md" />
//           <div className="h-5 w-36 bg-gray-300 dark:bg-gray-600 rounded-md" />
//         </div>
//       </div>
//     </div>
//     <div className="px-6 pb-6">
